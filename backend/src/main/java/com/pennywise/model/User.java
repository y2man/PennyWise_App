...
public class User {
    ...
    @Column(name = "otp_expiry") private LocalDateTime otpExpiry;
    ...
    public String getOtpCode() { return otpCode; } public void setOtpCode(String o) { otpCode = o; }
    public LocalDateTime getOtpExpiry() { return otpExpiry; } public void setOtpExpiry(LocalDateTime o) { otpExpiry = o; }
