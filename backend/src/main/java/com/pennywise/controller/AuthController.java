...
public class AuthController {
    ...
    public ResponseEntity<?> forgot(@RequestBody Map<String, String> body) {
        ...
        if (u == null) {
            return ResponseEntity.ok(Map.of("message", "If registered, a code was sent."));
        }
    ...
    public ResponseEntity<?> verify(@RequestBody Map<String, String> body) {
        ...
        // Clear OTP immediately after verification for security
        u.setOtpCode(null);
        u.setOtpExpiry(null);
        userRepo.save(u);
    ...
    public ResponseEntity<?> reset(@RequestBody Map<String, String> body) {
        ...
        if (t == null || !jwtUtil.isValid(t)) {
            return ResponseEntity.badRequest().body(Map.of("error", "Invalid token"));
        }
        String sub = jwtUtil.extractEmail(t);
        if (!sub.startsWith("RESET:")) {
            return ResponseEntity.badRequest().body(Map.of("error", "Wrong token type"));
        }
